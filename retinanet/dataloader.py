...
class CSVDataset(Dataset):
    ...
    def __init__(self, train_file, class_list, transform=None):
        ...
        try:
            ...
            raise (ValueError('invalid CSV class file: {}: {}'.format(self.class_list, e)), None) from e
        ...
        try:
            ...
            raise (ValueError('invalid CSV annotations file: {}: {}'.format(self.train_file, e)), None) from e
    ...
    def _parse(self, value, function, fmt):
        ...
        try:
            ...
            raise (ValueError(fmt.format(e)), None) from e
...
class ImgResizer(object):
    ...
    def __call__(self, img, min_side=608, max_side=1024):
        ...
        return torch.from_numpy(new_image.transpose((2, 0, 1)))
